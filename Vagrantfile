...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision 'shell', path: './vagrant/provision/node.sh', privileged: false
  config.vm.provision 'shell', path: './vagrant/provision/always.sh', run: 'always', privileged: false
end
